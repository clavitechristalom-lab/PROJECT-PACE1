...
class SearchController extends Controller
{
    public function search(Request $request)
    {
        ...
        $modules = [
            ...
            ['title' => 'Installment Accounts', 'subtitle' => 'Active Loans, Terms & Payment Schedules', 'keywords' => ['installment', 'installments', 'loan', 'loans', 'credit', 'amortization', 'monthly plan'], 'route' => '/installments', 'icon' => '📑', 'module' => 'Navigation', 'roles' => ['Administrator', 'Store Administrator']],
